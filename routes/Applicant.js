...
// GET /Applicant/:id route to retrieve an applicant given its id
...
// DELETE /Applicant/:id to delete an applicant given its id
...
// PUT /Applicant/:id to update an applicant given its id
